...
def render_clustering_backend_controls():
    ...
    backend_options = ["auto", "sklearn"]
    backend_help_parts = ["auto: Smart backend selection", "sklearn: Standard CPU clustering"]
    ...
    try:
        import faiss
        has_faiss = True
        backend_options.append("faiss")
        backend_help_parts.append("faiss: Fast CPU clustering")
    except ImportError:
        pass
    ...
    try:
        ...
        if cp.cuda.is_available():
            has_cuda = True
            backend_options.append("cuml")
            backend_help_parts.append("cuml: GPU-accelerated clustering")
    except ImportError:
        pass
